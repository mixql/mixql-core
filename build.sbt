...
Antlr4 / antlr4FolderToClean :=
  (Antlr4 / javaSource).value / "org" / "mixql" / "core" / "generated"

lazy val mixQLCore = (project in file(".")).enablePlugins(Antlr4Plugin).settings(
  ...
  scmInfo :=
    Some(ScmInfo(url("https://github.com/mixql/mixql-core"), "scm:git@github.com:mixql/mixql-core.git")),
  developers :=
    List(
